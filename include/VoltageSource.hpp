 ...
 * @brief Defines the VoltageSource class for circuit simulation.
 *
 * This file contains the definition of the VoltageSource class, which models a
 * voltage source element in an electrical circuit. It inherits from
...
/**
 * @class VoltageSource
 * @brief Represents a voltage source element in the circuit.
 *
 * The VoltageSource class provides methods for stamping its contribution into
 * the MNA matrix and for parsing a voltage source from a netlist. Inherits from
 * CircuitElement.
 */
class VoltageSource : public CircuitElement
{
   public:
    /**
     * @brief Constructs a VoltageSource element.
     * @param name Name of the voltage source element.
    ...
    /**
     * @brief Stamps the voltage source's contribution into the MNA matrix and
     * RHS vector.
    ...
    /**
     * @brief Parses a voltage source element from netlist tokens.
     ...
     * @return Shared pointer to the created VoltageSource element.
     */
